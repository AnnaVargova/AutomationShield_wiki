...
<img src="http://latex.codecogs.com/gif.latex?K_{\mathrm{P}}=0.1" border="0"/> , <img src="http://latex.codecogs.com/gif.latex?T_{\mathrm{I}}=0.015" border="0"/> and <img src="http://latex.codecogs.com/gif.latex?T_{\mathrm{D}}=0.015" border="0"/>. Despite the true hysteretic an nonlinear nature of the process the PID algorithm handles feedback control quite well. Note that the output oscillates around the setpoint &mdash especially at lower reference levels &mdash because the LED is powered by a PWM signal instead of a stable true analog input from a digital-to-analog converter (DAC).
