...
The circuit schematics has been designed in the Freeware version of the [DIPTrace](https://diptrace.com/) CAD software. You may download the circuit schematics for the OptoShield from [here]https://github.com/gergelytakacs/AutomationShield/wiki/file/OptoShield_PCB.zip). 
